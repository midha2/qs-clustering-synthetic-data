...
class Group:
    def __init__(self, name: str, occurrence_prob: float, preferences: list[int], sigma=1.0):
        self.name = name
...
class NormalSyntheticData:
    ...
    def __generateResponses(self):
        ...
        for i in range(num_responses):
            ...
            for j in range(num_categories):
                responses[j, i] = rd.normalvariate(group_of_person_i.preferences[j], sigma=group_of_person_i.sigma)
    ...
    def _scaleGroups(self):
        ...
        for group in self.groups:
            ...
            target_budget = self.credit_budget - (group.sigma/2)
...
new_groups = [Group(name='White', occurrence_prob = 0.59, preferences = [-5, 1, 0, 0], sigma=1),
          ...
          Group('Asian', 0.07, [-2, -1, 1, 4], sigma=0.8)]
num_credits = 80
